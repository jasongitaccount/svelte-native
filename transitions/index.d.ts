...
export declare function asSvelteTransition(node: NativeViewElementNode<View>, delay: number, duration: number, curve: string | CubicBezierAnimationCurve, nativeAnimationProps: (t: number) => NativeAnimationDefinition): any;
